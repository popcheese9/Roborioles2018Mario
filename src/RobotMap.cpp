...
std::shared_ptr<frc::Compressor> RobotMap::clampCompressor;
...
void RobotMap::init() {
    ...
    clampClamper.reset(new frc::Solenoid(0, 0));
    lw->AddActuator("Clamp", "Clamper", clampClamper);
    
    clampCompressor.reset(new frc::Compressor(0));
    lw->AddActuator("Clamp", "Compressor", clampCompressor);

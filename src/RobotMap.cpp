...
std::shared_ptr<frc::Solenoid> RobotMap::driveBaseShiftController;
...
void RobotMap::init() {
    ...
    driveBaseShiftController.reset(new frc::Solenoid(0, 1));
    lw->AddActuator("DriveBase", "ShiftController", driveBaseShiftController);
